...
namespace VinToolsEditor.BetterRuleTiles
{
    public class HexagonalEditorGrid : EditorGridBase
    {
        ...
        {
            Handles.BeginGUI();
            Handles.color = tex.GetPixel(0, 0);

            for (int x = 0; x < size.x; x++)
            {
                for (int y = 0; y < size.y; y++)
                {
                    var rect = GetGridPos(tile + new Vector2Int(x, y));
                    ...
                    if (!_flatTop)
                    {
                        bool O = Mathf.Abs(tile.y + y) % 2 != 0;

                        if (U) Handles.DrawPolyLine(new Vector2(rect.x + rect.width, rect.y + rect.height * .25f), new Vector2(rect.x + rect.width / 2, rect.y), new Vector2(rect.x, rect.y + rect.height * .25f));
                        if (D) Handles.DrawPolyLine(new Vector2(rect.x + rect.width, rect.y + rect.height * .75f), new Vector2(rect.x + rect.width / 2, rect.y + rect.height), new Vector2(rect.x, rect.y + rect.height * .75f));
                        ...
                        if (L && O && !D) Handles.DrawLine(new Vector2(rect.x, rect.y + rect.height * .75f), new Vector2(rect.x + rect.width * .5f, rect.y + rect.height));
                        if (L && !O && !D) Handles.DrawLine(new Vector2(rect.x - rect.width * .5f, rect.y + rect.height), new Vector2(rect.x, rect.y + rect.height * .75f));
                        if (R && !O && !D) Handles.DrawLine(new Vector2(rect.x + rect.width * .5f, rect.y + rect.height), new Vector2(rect.x + rect.width, rect.y + rect.height * .75f));
                        if (R && !O && !U) Handles.DrawLine(new Vector2(rect.x + rect.width * .5f, rect.y), new Vector2(rect.x + rect.width, rect.y + rect.height * .25f));
                    }
                    else
                    {
                        bool O = Mathf.Abs(tile.x + x) % 2 != 0;

                        if (U) Handles.DrawLine(new Vector2(rect.x + rect.width * .25f, rect.y), new Vector2(rect.x + rect.width * .75f, rect.y));
                        if (D) Handles.DrawLine(new Vector2(rect.x + rect.width * .25f, rect.y + rect.height), new Vector2(rect.x + rect.width * .75f, rect.y + rect.height));
                        ...
                        if (U && O && !R) Handles.DrawLine(new Vector2(rect.x + rect.width * .75f, rect.y), new Vector2(rect.x + rect.width, rect.y + rect.height * .5f));
                        if (D && !O && !L) Handles.DrawLine(new Vector2(rect.x, rect.y + rect.height * .5f), new Vector2(rect.x + rect.width * .25f, rect.y + rect.height));
                        if (U && O && !L) Handles.DrawLine(new Vector2(rect.x, rect.y + rect.height * .5f), new Vector2(rect.x + rect.width * .25f, rect.y));
                        if (D && !O && !R) Handles.DrawLine(new Vector2(rect.x + rect.width * .75f, rect.y + rect.height), new Vector2(rect.x + rect.width, rect.y + rect.height * .5f));
                    }
                }
            }
